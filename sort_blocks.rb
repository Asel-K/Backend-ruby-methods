...
#For your first call to sort, pass a block so that the array is sorted 
#in order of title, and print out the array.  
#For your second call to sort, pass a block so that the array is sorted 
#in order of copies, and print out the array.
